...
public class EscapeSequences {
    ...
    public static final String SET_TEXT_COLOR_DEFAULT = SET_TEXT_COLOR + "39m";
    ...
    public static final String SET_BG_COLOR_DEFAULT = SET_TEXT_COLOR + "49m";
    public static final String RESET = SET_TEXT_COLOR + "39;49;0m";
