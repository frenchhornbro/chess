...
public class RookMovesCalculator implements PieceMovesCalculator {
    ...
    public Collection<ChessMove> pieceMoves (ChessBoard board, ChessPosition startPosition) {
        ...
        addMoves(possibleMoves,startPosition, board,true,true);
        addMoves(possibleMoves,startPosition, board,true,false);
        addMoves(possibleMoves,startPosition, board,false,false);
        addMoves(possibleMoves,startPosition, board,false,true);
        return possibleMoves;
    }
    private void addMoves(ArrayList<ChessMove> possibleMoves, ChessPosition startPos, ChessBoard board, boolean isRow, boolean isAdd) {
